const NoteBoxFactory = artifacts.require('NoteBoxFactory')
...
module.exports = async (deployer, network, [defaultAccount]) => {
  ...
  if (network.startsWith('rinkeby')) {
    await deployer.deploy(NoteBoxFactory, RINKEBY_VRF_COORDINATOR, RINKEBY_LINKTOKEN, RINKEBY_KEYHASH)
    let dnd = await NoteBoxFactory.deployed()
    ...
    // await deployer.deploy(NoteBoxFactory)
    // let dnd = await NoteBoxFactory.deployed()
  }
}
